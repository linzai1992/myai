...
class SpeechSynthesisModel:
    def __init__(self, sequence_length, vocab_size, embedding_size, output_shape):
        ...
        with tf.variable_scope("speech_synthesizer"):
            ...
            c_conv3 = tf.nn.conv2d_transpose(a_conv2, W_conv3, [-1, output_shape[0]//2, output_shape[1]//2, 128], strides=[1, 1, 256, 1], padding="SAME")
            ...
            c_conv4 = tf.nn.conv2d_transpose(a_conv3, W_conv4, [-1] + output_shape + [2], strides=[1, 2, 2, 1], padding="SAME")
